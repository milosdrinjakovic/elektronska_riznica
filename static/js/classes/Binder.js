...
export default class Binder {
  ...
  constructor(visual, p, hidden=false) {
    ...
    this.backG = new THREE.BoxGeometry(0.001, this.p.backSize, p.cover.height);
    ...
    const transparent = {opacity: 0, transparent: true};
    this.materials = [
                      new THREE.MeshPhongMaterial(color),
                      new THREE.MeshPhongMaterial(color),
                      new THREE.MeshPhongMaterial(transparent),//{opacity: 0, transparent: true}
